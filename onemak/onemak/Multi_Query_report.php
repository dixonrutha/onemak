                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Evangelist Multi Query Report </h3>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Report</button>
                                        <ul class="dropdown-menu">
                                           
                                            <li><a href="Multi_Query_Report.xlsx"><img src='img/icons/xls.png' width="24"/> Excel </a></li>
								...
								$sql = "SELECT * FROM evangelists_monthly_report WHERE year='$year' AND month='$month' $conc_Query ORDER BY $order_by DESC";
								//echo $sql;
								$query = mysql_query($sql,$connect)or die(mysql_error());
								//data-toggle="tooltip"
								MultiQueryReport($month,$year,$order_by,$sql,$zoneID);
								?>
