...
function returnUserEmail($UserID)
{
	require('connection.php');
	$query = mysql_query("SELECT * FROM  users_table WHERE ID='$UserID' ",$connect)or die(mysql_error());
	$fetch_data = mysql_fetch_array($query);
	return $fetch_data['email'];
}
...
function System_Navigation()
{
    ...
    <ul class="x-navigation">
                    ...
                    <li class="xn-profile">
                        ...
                        <div class="profile">
                            ...
                            <div class="profile-controls">
                                <a title="Update Your Profile" href="#" class="profile-control-left"><span class="fa fa-user"></span></a>
                    ...
                    <?php
					if($_SESSION['StaffSide']=="Evangelists")
					{
					?>                 
                    <li>
                        <a href="Conferences_list_home.php"><span class="fa fa-desktop"></span> <span class="xn-text">Market Lists </span></a>
                    </li>
                    
                    <li>
                        <a href="products_lists.php"><span class="fa fa-desktop"></span> <span class="xn-text">Farm Products </span></a>
                    </li>

                    <li>
                        <a href="Users_orders.php"><span class="fa fa-desktop"></span> <span class="xn-text"> User Orders </span></a>
                    </li>

                    <li class="xn-openable">
                                <a href="#"><span class="fa fa-desktop"></span> Reports </a>
                                <ul>                                    
                                    <li><a href="products_weekly_report.php"> Weekly Reports </a></li>
                                    <li><a href="products_monthly_report.php">Monthly Report</a></li>
                                    <li><a href="product_annual_report.php"> Annual Report</a></li>
                                </ul>
                            </li> 
					...
					else if($_SESSION['StaffSide']=="Publishing")
					{
					?>
...
function return_staff_name($username)
{
	...
	$fetch_staff_details = mysql_fetch_array($query);
	return $fetch_staff_details['LastName']." , ".$fetch_staff_details['FirstName']." ".$fetch_staff_details['Middlename'];
}
