        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Zones Quartely Summary</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> All Zones Quartely Summaries </h3>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Choose Report Quarter and Year</h4>
      </div>
										...
										else
										{
											...
											while($fetch_conferences_lists = mysql_fetch_array($query))
											{
                                                ...
                                                <?php
													...
													$sum_hours = $sum_hours + ZoneSummaryQuarterz($zoneID,$month,$year,'hours');
													$sum_books_sold = $sum_books_sold + ZoneSummaryQuarterz($zoneID,$month,$year,'books_sold');
													$sum_magazines_sold = $sum_magazines_sold + ZoneSummaryQuarterz($zoneID,$month,$year,'Magazines');
													$sum_value_sale = $sum_value_sale + ZoneSummaryQuarterz($zoneID,$month,$year,'Value_sales');
													$free_literature = $free_literature + ZoneSummaryQuarterz($zoneID,$month,$year,'free_literature');
													$vop = $vop + ZoneSummaryQuarterz($zoneID,$month,$year,'v_o_p');
													$attending_ss = $attending_ss + ZoneSummaryQuarterz($zoneID,$month,$year,'people_attending_SS');
													$back_slinders = $back_slinders + ZoneSummaryQuarterz($zoneID,$month,$year,'sda_back_slinders');
													$prayers = $prayers + ZoneSummaryQuarterz($zoneID,$month,$year,'prayers_offered');
													$bible_studies = $bible_studies + ZoneSummaryQuarterz($zoneID,$month,$year,'Bibles_studies_given');
													
													$baptism_classes = $baptism_classes + ZoneSummaryQuarterz($zoneID,$month,$year,'people_joining_bapstism_classes');
													$baptized = $baptized + ZoneSummaryQuarterz($zoneID,$month,$year,'no_baptised');
													$visited = $visited + ZoneSummaryQuarterz($zoneID,$month,$year,'Waliotembelewa');
													
													
													?>
                                               
                                                
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'hours')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'books_sold')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'Magazines')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'Value_sales')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'free_literature')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'v_o_p')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'people_attending_SS')); ?> </td>                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'sda_back_slinders')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'prayers_offered')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'Bibles_studies_given')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'people_joining_bapstism_classes')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'no_baptised')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryQuarterz($zoneID,$month,$year,'Waliotembelewa')); ?> </td>
