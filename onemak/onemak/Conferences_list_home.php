        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Markets List</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Mwanza Market Lists</h3>
								...
								?>
                                <a href="?add_new_market=1"  data-toggle="tooltip" data-placement="right" title="Click to Add/Register a New Farm Product(s) Market"><b>Register New Market </b> </a> <!--| <a href="?view_union_summary=1"  data-toggle="tooltip" data-placement="right" title="Click to View Union Evangelist Summary "><b> View Union Summary </b> </a>--><br><br>
                                    ...
                                    <table id="customers" class="table table-striped">
										...
										if(mysql_num_rows($query)==0)
										{
											?>
                                            <tr>
                                            <td colspan="8"> No Product Markets regisered in Mwanza </td> </tr>
                                            </tr>
                                            <?php
										}	
										else
										...
										?>
                                            <tr>
                                            	<td> <?php echo $num; ?>. </td>
                                                <td> <?php echo $fetch_conferences_lists['MarketName']; ?> </td>
                                                <td> <?php echo $fetch_conferences_lists['District']; ?> </td>
                                                <td> <?php echo $fetch_conferences_lists['Region']; ?> </td>
                                                <td> <?php echo $fetch_conferences_lists['Street']; ?> </td>
                                                ...
                                                <div class="btn-group pull-right"> 
                                                	<a href="#" data-toggle="dropdown" > Action </a>
                                                		<ul class="dropdown-menu">
                                                			...
                                                			<li> <a onclick="return DeleteConfirm('<?php echo $fetch_conferences_lists['MarketName']; ?> Market ?')" href="?delete_market=<?php  echo $fetch_conferences_lists['ID']; ?>"> Delete <?php echo $fetch_conferences_lists['MarketName']; ?> Details </a> </li>
                                                		</ul>
                                                 </div>
                                                 </td>
                                            </tr>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Register a new Market </h3>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="market_name" class="form-control" placeholder="Market Name" required/>
                                                    </div>                                            
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-9">                                            
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" name="district" class="form-control" placeholder="Disrict" required/>
                                                    </div>                                            
                                            ...
                                            <div class="form-group">                                        
                                             ...
                                             <div class="form-group">                                        
                                                ...
                                                <div class="col-md-9">
                                                    <div class="input-group">
                                                        <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                        <input type="text" class="form-control" placeholder="In Charge" name="incharge">                                            
                                                    </div>
                                ...
                                <div class="panel-footer">
                                    <button class="btn btn-default">Clear Form</button>                                    
                                    <button class="btn btn-primary pull-right" type="submit" name="Save_new_zone">Save</button>
                                </div>
                            </div>
                            </form>
...
<!-- End Modal-->
                ...
                {
                    EditMarketDetails($_GET['Edit_market_info']);
                }
				...
				else if(isset($_POST['Save_new_zone']))
				{
					...
					//$zone_abbrev = $_POST['zone_abbrev'];
					
					require('connection.php');
					
					$query = mysql_query("SELECT * FROM markets WHERE MarketName='$market_name'  ",$connect)or die(mysql_error());
					...
					{
						$insertQuery = mysql_query("INSERT INTO markets(MarketName,District,Region,Street,Phone,Incharge) VALUES('$market_name','$district','$region','$Street','$phone_number','$incharge') ",$connect)or die(mysql_error());	
					}
                ...
                else if(isset($_GET['delete_market']))
                {
                    ...
                    require('connection.php');
                    $query = mysql_query("DELETE FROM markets WHERE ID='$marketID' ",$connect)or die(mysql_error());
				...
				else
				{
					...
					{
						View_Conference_Single($_SESSION['ConferenceID'],$reportID);	
					}
				}
