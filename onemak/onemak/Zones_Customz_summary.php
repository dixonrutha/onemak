        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Zones Custom Summary</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> All Zones Custom Summaries </h3>
								...
								if($_SESSION['access_level']==20)
								{
									...
									$query_more = " WHERE ID = '$confIDzz' ";
								}
								
								$sql = "SELECT * FROM conferences_list $query_more ";
								//echo $sql;
									 ...
									 <table id="customers" class="table table-striped">
										...
										else
										{
											...
											while($fetch_conferences_lists = mysql_fetch_array($query))
											{
												...
												while($fetch_zones = mysql_fetch_array($queryzonesLists))
												{
													$num++;
													$zoneID = $fetch_zones['ID'];
												?>
                                            	<tr>
                                            	<td> <?php echo $num; ?>. </td>
                                                <td> <?php echo $fetch_zones['ZoneName']; ?></td>
                                                <td> <?php echo $fetch_conferences_lists['Abbreviation']; ?>  </td>
                                                <?php
												
													$sum_hours = $sum_hours + ZoneSummaryCustomz($zoneID,$month,$year,'hours',$start_month);
													$sum_books_sold = $sum_books_sold + ZoneSummaryCustomz($zoneID,$month,$year,'books_sold',$start_month);
													$sum_magazines_sold = $sum_magazines_sold + ZoneSummaryCustomz($zoneID,$month,$year,'Magazines',$start_month);
													$sum_value_sale = $sum_value_sale + ZoneSummaryCustomz($zoneID,$month,$year,'Value_sales',$start_month);
													$free_literature = $free_literature + ZoneSummaryCustomz($zoneID,$month,$year,'free_literature',$start_month);
													$vop = $vop + ZoneSummaryCustomz($zoneID,$month,$year,'v_o_p',$start_month);
													$attending_ss = $attending_ss + ZoneSummaryCustomz($zoneID,$month,$year,'people_attending_SS',$start_month);
													$back_slinders = $back_slinders + ZoneSummaryCustomz($zoneID,$month,$year,'sda_back_slinders',$start_month);
													$prayers = $prayers + ZoneSummaryCustomz($zoneID,$month,$year,'prayers_offered',$start_month);
													$bible_studies = $bible_studies + ZoneSummaryCustomz($zoneID,$month,$year,'Bibles_studies_given',$start_month);
													
													$baptism_classes = $baptism_classes + ZoneSummaryCustomz($zoneID,$month,$year,'people_joining_bapstism_classes',$start_month);
													$baptized = $baptized + ZoneSummaryCustomz($zoneID,$month,$year,'no_baptised',$start_month);
													$visited = $visited + ZoneSummaryCustomz($zoneID,$month,$year,'Waliotembelewa',$start_month);
													
													
													?>
                                               
                                                
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'hours',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'books_sold',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'Magazines',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'Value_sales',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'free_literature',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'v_o_p',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'people_attending_SS',$start_month)); ?> </td>                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'sda_back_slinders',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'prayers_offered',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'Bibles_studies_given',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'people_joining_bapstism_classes',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'no_baptised',$start_month)); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummaryCustomz($zoneID,$month,$year,'Waliotembelewa',$start_month)); ?> </td>
