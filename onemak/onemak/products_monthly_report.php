    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
				...
				function View_Conference_Single($marketID,$year,$month)
				{
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Farm Products Prices (Monthly Report) - <?php echo return_conference_name($marketID);  ?> MARKET </h3>
                               ...
                               $sql = "SELECT * FROM product_prices_dates WHERE MarketID='$marketID' AND Enddate LIKE '$year-$month-%' ORDER BY Enddate ASC ";

                               //echo $sql;

								$sql2 = "SELECT * FROM product_prices_dates WHERE MarketID='$marketID' ";
                                    ...
                                    <table id="customers" class="table table-striped">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> Product Name </th>
                                                <?php 
                                                while($fetch_th_range = mysql_fetch_array($query))
                                                {
                                                    ?>
                                                    <th> <?php echo Date_formating($fetch_th_range['Startdate']).'-'.Date_formating($fetch_th_range['EndDate']); ?> </th>
                                                    <?php 
                                                }
                                                ?>
                                            </tr>
										...
										?>
                                            <tr>
                                                ...
                                                <?php 
                                                $queryPrices = mysql_query($sql,$connect)or die(mysql_error());
                                                while($fetchQueryPrice = mysql_fetch_array($queryPrices))
                                                {
                                                    $id_records = $fetchQueryPrice['ID'];
                                                    $minimum_price = returnProductReportValues22($productID,$id_records,'minimum_value');
                                                    $maximum_price = returnProductReportValues22($productID,$id_records,'maximum_value');
                                                    $avgValue = ($minimum_price+$maximum_price)/2;
                                                    ?>
                                                    <td>
                                                    <?php echo number_format($avgValue); ?>
                                                    </td>
                                                <?php
                                                }
                                                ?>
...
<!-- End Modal-->
                ...
                {
                    View_Conference_Single($_GET['marketID'],$_GET['year'],$_GET['month']);
                }
				else
				{
                    $year = date('Y');
