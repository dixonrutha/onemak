        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Available Product Request</li>
                </ul>
                <!-- END BREADCRUMB -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                ...
                                <h3 class="panel-title"> Available Product Orders / Requests </h3>
								...
								$sql = "SELECT * FROM users_requests ORDER BY ID DESC";
                                ...
                                <!--<a href="#chooseMarketModal" data-toggle="modal" data-placement="right" title="Click to Create a New Product Order/Request "><b>Create a New Products Order/Request </b> </a> | <a href="?view_union_summary=1"  data-toggle="tooltip" data-placement="right" title="Click to View Union Evangelist Summary "><b> View Union Summary </b> </a><br><br> -->
                                    ...
                                    <table id="customers" class="table table-striped">
										...
										if(mysql_num_rows($query)==0)
										{
											?>
                                            <tr>
                                            <td colspan="8"> There is No Records of any Requests from you </td> </tr>
                                            </tr>
                                            <?php
										}	
										else
										...
										?>
                                            <tr>
                                                ...
                                                <td> <?php echo returnUserEmail($fetch_conferences_lists['UserID']); ?> </td>
                                                ...
                                                <div class="btn-group pull-right"> 
                                                	<a href="#" data-toggle="dropdown" > Action </a>
                                                		<ul class="dropdown-menu">
                                                			...
                                                			<li> <a href="?view_order_full_details=<?php echo $fetch_conferences_lists['ID']; ?>&marketID=<?php echo $fetch_conferences_lists['marketID']; ?>"> View Full Order Details </a> </li>
