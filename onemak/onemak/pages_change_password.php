...
$checkCurrentpassword=mysql_query("SELECT * FROM publishing_staffs WHERE username='$_SESSION[username]' AND Passwordi='$currentpassword'",$connect)or die('Could not confirm the new password due to '.mysql_error());
...
$update=mysql_query("UPDATE publishing_staffs SET Passwordi='$newpassword' WHERE username='$_SESSION[username]'",$connect)or die('Could not update the password value in the table due to '.mysql_error());
