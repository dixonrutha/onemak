	...
	else
	{
                ...
                <div class="tableExits">
                    <a href="kn_products_more.html">
                        <div class="tableProductName">
                            <span> <?php echo $fetch_markets['MarketName']; ?> Market </span>
                        </div>
                        <div class="tableProductHeader">
                            <div class="tableHeader foodName ">Mazao</div>
        ...
        <div class="footer">
            <ul class="listWrapper">
                ...
                <li class="listFooter"> <a href="#"> Usalama </a> </li>
            </ul>

            <div class="copyRght">&copy 2017 One Market Solution </div>
        </div>
