    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
				...
				function View_Evangelists_Reports($conferenceID,$year,$month,$sql,$order_by_which,$direction,$item_analysed,$start_month)
				{
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Evangelist Custom Report - <?php echo return_conference_name($conferenceID); ?> </h3>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Report</button>
                                        <ul class="dropdown-menu">
                                           
                                            <li><a href="Evangellists_Custom_report.xlsx"><img src='img/icons/xls.png' width="24"/> Excel </a></li>
								...
								//data-toggle="tooltip"
								ExportCustomEvangelistsReport($conferenceID,$year,$month,$sql,$order_by_which,$direction,$item_analysed,$start_month);
								?>
                               <!-- <a href="?View_zone_single=<?php echo $zoneID; ?>" data-toggle="tooltip" data-placement="bottom" title="Click to View List of Evangelists "> <b> Evangelists Detail List </b> </a> <br><br> -->
                                ...
                                Showing Report for <?php echo $array_months[$start_month]." To ".$array_months[$month]; ?> , <?php echo $year; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="col-md-6">
                                                ...
                                                <div class="col-md-9">                                                                                            
                                                    <select required class="form-control select" name="start_month" required>
...
<!-- End Modal-->
                                    ...
                                    <table id="customers" class="table table-striped" border="1">
                                        <thead>
                                            ...
                                            <tr>
                                            <th colspan="3"> </th>
                                            <th> <center><?php echo $array_months[$start_month]."  To ".$array_months[$month]." ,".($year-1); ?></center> </th> <th> <center><?php echo $array_months[$start_month]."  To ".$array_months[$month]." ,".$year; ?></center> </th>
                                            <th> <center>%</center> </th>
                                          ...
                                          <?php
										  	if(mysql_num_rows($fetch_evangelists_Query)>0)
											{
												...
												while($fetch_evangelists_results = mysql_fetch_array($fetch_evangelists_Query))
												{
                                                    ...
                                                    <?php
													$old_val = Sum_Item_Custom($evangID,$month,$year-1,$item_analysed,$start_month);
													$new_val = Sum_Item_Custom($evangID,$month,$year,$item_analysed,$start_month);
													?>
                                                    ...
                                                    <td align="center"> <?php echo ArrangezoneCustom($evangID,$month,$year,$item_analysed,$zoneID,$start_month); ?> </td>
                                                    <td align="center"> <?php echo ArrangeConfCustom($evangID,$month,$year,$item_analysed,$zoneID,$conferenceID,$start_month); ?> </td>
                                                    <td align="center"> <?php echo ArrangeUnionCustom($evangID,$month,$year,$item_analysed,$zoneID,$conferenceID,$start_month); ?> </td>
                                                    </tr>
                                                    <?php
												}//end function 
											}
				...
				if(isset($_GET['month']))
				{
					View_Evangelists_Reports($_GET['confID'],$_GET['year'],$_GET['month'],$sql,$order_by_which,$direction,$_GET['order_by'],$_GET['start_month']);
				}
				else
				{
					$year = date('Y');
					$month = date('m')-1;
					View_Evangelists_Reports('1',$year,$month,$sql,$order_by_which,$direction,'Value_sales',1);
				}
				?>
