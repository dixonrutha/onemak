    ...
    <body>
        ...
        <div class="page-container">
            ...
            <div class="page-content">
				...
				function View_Conference_Single($marketID)
				{
				?>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Farm Products Prices (Weekly Report)</h3>
								...
								$sql = "SELECT * FROM product_prices_dates WHERE MarketID='$marketID' ";
...
<!-- End Modal-->
                                    ...
                                    <table id="customers" class="table table-striped">
										...
										?>
                                            <tr>
                                                ...
                                                <td> <?php echo Date_formating($fetch_conferences_lists['Startdate']); ?></td>
                                                <td> <?php echo Date_formating($fetch_conferences_lists['EndDate']); ?></td>
                                                
                                                <td>
                                                <div class="btn-group pull-right"> 
                                                	<a href="#" data-toggle="dropdown" > Action </a>
                                                		<ul class="dropdown-menu">
                                                			<li> <a href="?View_single_report=<?php echo $fetch_conferences_lists['ID']; ?>"> View this report </a> </li> 
                ...
                function View_Single_report($reportID)
                {
                    ...
                    $sql = "SELECT * FROM product_prices_dates WHERE ID='$reportID' ";

                    $queryFirst = mysql_query($sql,$connect)or die(mysql_error());
...
<!-- End Modal-->
                            ...
                            <b> Bar Chart / Histogram for Product Prices </b> <br><br>

                            <?php 
        $query_products = mysql_query("SELECT * FROM products",$connect)or die(mysql_error());
        $conc = array();
        $conc2 = array();
        $num = 0;
        while($fetch_products = mysql_fetch_array($query_products))
        {
            $num++;
            $product_name = $fetch_products['ProductName'];
            $productID = $fetch_products['ProductID'];
            $productPrice = FindAveragePrice($productID,$reportID);

            $conc[$num-1] = $product_name;
            $conc2[$num-1] = $productPrice;
 ...
 /*
 $DataSet = new pData;
 $DataSet->AddPoint($conc2,"Serie1");
 //$DataSet->AddPoint(array(20,60,89,12,4),"Serie1");
 $DataSet->AddPoint($conc);
 ...
 $Test->drawBasicPieGraph($DataSet->GetData(),$DataSet->GetDataDescription(),180,130,110,PIE_PERCENTAGE_LABEL,FALSE,50,20,5);
 $Test->drawPieLegend(330,15,$DataSet->GetData(),$DataSet->GetDataDescription(),250,250,250);

 // Write the title
 $Test->setFontProperties("Fonts/MankSans.ttf",10);
 $Test->drawTitle(10,20,"Lvemp II CDD Projects per Districts ",100,100,100);
...
<!--<img src="example10.png">-->
 ...
 $DataSet = new pData;
 $DataSet->AddPoint($conc2,"Serie1");
 $DataSet->AddPoint($conc,"Serie3");  
 
 $DataSet->AddSerie("Serie1");  
 //$DataSet->AddAllSeries();
 $DataSet->SetAbsciseLabelSerie("Serie3");
 $DataSet->SetSerieName("Bei za Bidhaa","Serie1");
 //$DataSet->SetSerieName($year,"Serie2");

 $DataSet->SetYAxisName("Bei");  
 $DataSet->SetXAxisName("Bidhaa");

 // Initialise the graph
 $Test = new pChart(700,350);
 $Test->setFontProperties("Fonts/tahoma.ttf",8);
 $Test->setGraphArea(100,30,585,200);
 $Test->drawFilledRoundedRectangle(7,7,693,223,5,240,240,240);
 $Test->drawRoundedRectangle(5,5,695,225,5,230,230,230);
 $Test->drawGraphArea(255,355,255,TRUE);
 ...
 $Test->drawTitle(50,22,"Graph ya Bei Za Bidhaa Sokoni",50,50,50,585);
...
<img src="example3.png" />
                ...
                {
                    View_Conference_Single($_GET['marketID']);
                }
				else
				{
					View_Conference_Single(1);
				}
