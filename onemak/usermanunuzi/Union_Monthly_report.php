        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Union Monthly Report</li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Union Evangelists Monthly Report - To be Sent to East and Central Africa Division(ECD) </h3>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Report</button>
                                        <ul class="dropdown-menu">
                                           
                                            <li><a href="Union_Summary_Monthly_Report.xlsx"><img src='img/icons/xls.png' width="24"/> Excel </a></li>
								...
								//data-toggle="tooltip"
								UnionMonthlyReportExport($month,$year);
								?>
										...
										else
										{
                                            ...
                                            <tr>
                                                ...
                                                <?php
													...
													$sum_hours = $sum_hours + UnionMonthlyFigure($confID,$month,$year,'hours');
													$sum_books_sold = $sum_books_sold + UnionMonthlyFigure($confID,$month,$year,'books_sold+Magazines');
													$sum_value_sale = $sum_value_sale + UnionMonthlyFigure($confID,$month,$year,'Value_sales');
													$free_literature = $free_literature + UnionMonthlyFigure($confID,$month,$year,'free_literature');
													
													$prayers = $prayers + UnionMonthlyFigure($confID,$month,$year,'prayers_offered');
													$bible_studies = $bible_studies + UnionMonthlyFigure($confID,$month,$year,'Bibles_studies_given');
													
													$baptized = $baptized + UnionMonthlyFigure($confID,$month,$year,'no_baptised');
													
													$visited = $visited + UnionMonthlyFigure($confID,$month,$year,'Waliotembelewa');
                                                ...
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'hours')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'Value_sales')); ?> </td>
                                                
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'books_sold+Magazines')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'free_literature')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'prayers_offered')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'Waliotembelewa')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'Bibles_studies_given')); ?> </td>
                                                <td align="center"> <?php echo number_format(UnionMonthlyFigure($confID,$month,$year,'no_baptised')); ?> </td>
