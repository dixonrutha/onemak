                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> APDD Monthly Report - <?php echo return_conference_name($conferenceID); ?> </h3>
...
<!-- End Modal-->
                                    ...
                                    <table id="customers" class="table table-striped">
										...
										else
										{
											...
											while($fetch_conferences_lists = mysql_fetch_array($query))
											{
												...
												$sum_hours = $sum_hours + Apdd_Monthly_Calculation($zoneID,$month,$year,'hours');
												$sum_books = $sum_books + Apdd_Monthly_Calculation($zoneID,$month,$year,'vitabu');
												$sum_visits = $sum_visits + Apdd_Monthly_Calculation($zoneID,$month,$year,'waliotembelewa');
												$sum_sales = $sum_sales + Apdd_Monthly_Calculation($zoneID,$month,$year,'mauzo_siku');
												?>
                                            	<tr>
                                                <td> <?php echo $num; ?>. </td>
                                            	<td> <?php echo $fetch_conferences_lists['ZoneName']; ?> </td>
                                                <td> <?php echo $fetch_conferences_lists['Assistant_Publishing_Director']; ?> </td>
                                                <td> <?php echo number_format(Apdd_Monthly_Calculation($zoneID,$month,$year,'hours')); ?> </td>
                                                <td> <?php echo number_format(Apdd_Monthly_Calculation($zoneID,$month,$year,'vitabu')); ?> </td>
                                                <td> <?php echo number_format(Apdd_Monthly_Calculation($zoneID,$month,$year,'mauzo_siku')); ?> </td>
                                                <td> <?php echo number_format(Apdd_Monthly_Calculation($zoneID,$month,$year,'waliotembelewa')); ?> </td>
                                              <?php
				...
				else
				{
					$year = date('Y');
					$month = date('m')-1;
					View_Evangelists_Reports('1',$year,'0'.$month,$sql,$order_by_which,$direction,'mauzo_siku');
				}
				?>
