...
require('evangelists_goals_excel_export.php');
CheckLogin_Validity();
        ...
        <div class="page-container">
            ...
            <div class="page-content">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Evangelists Goals </li>
                </ul>
                <!-- END BREADCRUMB -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Evangelist Goals Report - <?php echo return_conference_name($conferenceID); ?> </h3>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Report</button>
                                        <ul class="dropdown-menu">
                                           
                                            <li><a href="evangelists_goals.xlsx"><img src='img/icons/xls.png' width="24"/> Excel </a></li>
								...
								//data-toggle="tooltip"
								Export_All_zones_reports($sql,$conferenceID,$year);
								?>
                                    ...
                                    <table id="customers" class="table table-striped" border="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th> Current GRADE </th>
                                                <th colspan="2"> <center> Goal and Value of Sales </center></th>
                                               <th> <center> Percent </center> </th>
                                               
                                            </tr>
                                            <tr>
                                            <th colspan="3"> </th>
                                            <th> <center> Year Goal </center> </th> <th> <center> Value of Sales </center> </th>
                                            <th> <center>%</center> </th>
                                          ...
                                          <?php
										  	if(mysql_num_rows($fetch_evangelists_Query)>0)
											{
												...
												while($fetch_evangelists_results = mysql_fetch_array($fetch_evangelists_Query))
												{
                                                    ...
                                                    <?php
													$old_val = ReturnGoals($year,$fetch_evangelists_results['Grade']);
													$new_val = Evangelists_Collection($evangID,$year);
													?>
