										...
										else
										{
											...
											while($fetch_conferences_lists = mysql_fetch_array($query))
											{
                                                ...
                                                <?php
													...
													$sum_hours = $sum_hours + ZoneSummary($zoneID,$month,$year,'hours');
													$sum_books_sold = $sum_books_sold + ZoneSummary($zoneID,$month,$year,'books_sold');
													$sum_magazines_sold = $sum_magazines_sold + ZoneSummary($zoneID,$month,$year,'Magazines');
													$sum_value_sale = $sum_value_sale + ZoneSummary($zoneID,$month,$year,'Value_sales');
													$free_literature = $free_literature + ZoneSummary($zoneID,$month,$year,'free_literature');
													$vop = $vop + ZoneSummary($zoneID,$month,$year,'v_o_p');
													$attending_ss = $attending_ss + ZoneSummary($zoneID,$month,$year,'people_attending_SS');
													$back_slinders = $back_slinders + ZoneSummary($zoneID,$month,$year,'sda_back_slinders');
													$prayers = $prayers + ZoneSummary($zoneID,$month,$year,'prayers_offered');
													$bible_studies = $bible_studies + ZoneSummary($zoneID,$month,$year,'Bibles_studies_given');
													
													$baptism_classes = $baptism_classes + ZoneSummary($zoneID,$month,$year,'people_joining_bapstism_classes');
													$baptized = $baptized + ZoneSummary($zoneID,$month,$year,'no_baptised');
													$visited = $visited + ZoneSummary($zoneID,$month,$year,'Waliotembelewa');
													
													
													?>
                                               
                                                
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'hours')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'books_sold')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'Magazines')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'Value_sales')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'free_literature')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'v_o_p')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'people_attending_SS')); ?> </td>                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'sda_back_slinders')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'prayers_offered')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'Bibles_studies_given')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'people_joining_bapstism_classes')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'no_baptised')); ?> </td>
                                                <td align="center"> <?php echo number_format(ZoneSummary($zoneID,$month,$year,'Waliotembelewa')); ?> </td>
