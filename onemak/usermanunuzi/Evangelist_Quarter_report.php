                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"> Evangelist Quartely Report - <?php echo return_conference_name($conferenceID); ?> </h3>
                                    <div class="btn-group pull-right">
                                        <button class="btn btn-danger dropdown-toggle" data-toggle="dropdown"><i class="fa fa-bars"></i> Export Report</button>
                                        <ul class="dropdown-menu">
                                           
                                            <li><a href="Evangellists_Quarter_report.xlsx"><img src='img/icons/xls.png' width="24"/> Excel </a></li>
								...
								//data-toggle="tooltip"
								ExportQuarterEvangelistsReport($conferenceID,$year,$month,$sql,$order_by_which,$direction,$item_analysed);
								?>
...
<!-- End Modal-->
                                          ...
                                          <?php
										  	if(mysql_num_rows($fetch_evangelists_Query)>0)
											{
												...
												while($fetch_evangelists_results = mysql_fetch_array($fetch_evangelists_Query))
												{
                                                    ...
                                                    <?php
													$old_val = Sum_Item_Quarter($evangID,$month,$year-1,$item_analysed);
													$new_val = Sum_Item_Quarter($evangID,$month,$year,$item_analysed);
													?>
                                                    ...
                                                    <td align="center"> <?php echo ArrangezoneQuarter($evangID,$month,$year,$item_analysed,$zoneID); ?> </td>
                                                    <td align="center"> <?php echo ArrangeConfQuarter($evangID,$month,$year,$item_analysed,$zoneID,$conferenceID); ?> </td>
                                                    <td align="center"> <?php echo ArrangeUnionQuarter($evangID,$month,$year,$item_analysed,$zoneID,$conferenceID); ?> </td>
                                                    </tr>
                                                    <?php
												}//end function 
											}
				...
				else
				{
					$year = date('Y');
					$month = date('m')-1;
					View_Evangelists_Reports('1',$year,1,$sql,$order_by_which,$direction,'Value_sales');
				}
				?>
